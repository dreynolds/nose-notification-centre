...
class NCPlugin(Plugin):
    ...
    def finalize(self, result):
        ...
        if result.wasSuccessful():
            ...
            msg = '%s All of your %s test(s) passed!' % (self.success_msg, result.testsRun)
        else:
            msg = '%s %s failures, %s errors from %s tests' % (self.failure_msg, failures, errors, result.testsRun)
